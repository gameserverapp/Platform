...
![Game server - update modal example](/img/dashboard/gameserver/gameserver_control_modal.jpg)

### Game server settings
Control the individual game server via the game server settings pages.

![Game server - settings controls](/img/dashboard/gameserver/gameserver_settings_controls.jpg)

### Cluster overview
Control one or multiple game servers via any cluster overview page.

![Game server - cluster controls](/img/dashboard/gameserver/gameserver_cluster_controls.jpg)

### Machine settings
Control one or multiple game servers via the `Game servers & services` page for the selected DediConnect machine.

![Game server - cluster controls](/img/dashboard/gameserver/gameserver_machine_controls.jpg)
...
![Game server - settings](/img/dashboard/gameserver/gameserver_settings.jpg)
...
![Game server - settings - basic](/img/dashboard/gameserver/gameserver_settings_basic.jpg)
...
![Game server - custom map](/img/dashboard/gameserver/gameserver_custom_map.jpg)
:::

### Change names

![Game server - settings - names](/img/dashboard/gameserver/gameserver_settings_names.jpg)
...
![Game server - settings - automation](/img/dashboard/gameserver/gameserver_settings_automation.jpg)
...
![Game server - settings - activity](/img/dashboard/gameserver/gameserver_settings_activity.jpg)

### Console
See the console output and send commands or chat to the game server.

![Game server - settings - consoles](/img/dashboard/gameserver/gameserver_settings_console.jpg)
...
![Game server - statistics](/img/dashboard/gameserver/gameserver_performance.jpg)

## Access control
Every game will have different access control settings, but generally there are a couple things you can expect (assuming the game supports these features):

- Whitelist / Reserved slots
- Twitch sub whitelist
- Whitelisted players for game server (GSA whitelisted)

:::info
This section is scheduled for an update and will have its documentation revised.
:::
...
![Game server - logs](/img/dashboard/gameserver/gameserver_logs.jpg)

## Activity
See what happened with the game server. Any errors, user & system actions are logged on the Activity page.

![Game server - activity](/img/dashboard/gameserver/gameserver_activity.jpg)
...
![Game server - connect](/img/dashboard/gameserver/gameserver_connect.jpg)
...
![Game server - danger zone - change game](/img/dashboard/gameserver/gameserver_dangerzone_change_game.jpg)
...
![Game server - danger zone - re-install](/img/dashboard/gameserver/gameserver_dangerzone_reinstall.jpg)
...
![Game server - danger zone - wipe](/img/dashboard/gameserver/gameserver_dangerzone_wipe.jpg)
...
![Game server - danger zone - wipe data](/img/dashboard/gameserver/gameserver_dangerzone_wipe_data.jpg)
...
![Game server - danger zone - custom ports](/img/dashboard/gameserver/gameserver_dangerzone_custom_ports.jpg)
...
![Game server - danger zone - migrate](/img/dashboard/gameserver/gameserver_dangerzone_migrate.jpg)
...
![Game server - danger zone - docker launch params](/img/dashboard/gameserver/gameserver_dangerzone_docker_params.jpg)
...
![Game server - danger zone - delete container](/img/dashboard/gameserver/gameserver_dangerzone_delete_container.jpg)
