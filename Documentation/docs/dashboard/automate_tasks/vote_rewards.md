...
Define what GSA should do once a player claims a vote by adding actions to the Vote reward. These are similar to Task actions. [Learn more about the available actions](/dashboard/delivery_builder/actions).
