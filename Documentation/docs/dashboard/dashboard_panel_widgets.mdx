...
:::tip Quick start
Pick a template or have it copy all widgets from an existing panel as the starting point for your new panel using the `Template` dropdown. [See template examples >](#template-examples)
:::
